...
if __name__ == '__main__':
    ...
    tasks = ["openbookqa", "arc_easy", "arc_challenge", "winogrande", "hellaswag"]
    ...
    hflm = HFLM(pretrained=model, tokenizer=tokenizer, batch_size=16, max_batch_size=32)
    res = lm_eval.simple_evaluate(hflm, tasks=tasks, num_fewshot=0, batch_size=16, max_batch_size=32,
                                  device=model.device)
    print(res["results"])
